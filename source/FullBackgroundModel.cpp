...
void FullBackgroundModel::readConfiguringParametersFromFile(const string inputFileName)
{
    ifstream inputFile;
    ...
    if (Nrows != 9)
    {
        cerr << "Wrong number of parameters that define the full background model (9 parameters expected)." << endl;
        exit(EXIT_FAILURE);
    }
